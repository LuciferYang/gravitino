...
/**
 * Spark 4.0 specific Gravitino Iceberg catalog implementation. Spark 4.0 moved the procedure types
 * out of Iceberg's package into its own and changed {@code loadProcedure} to return {@link
 * UnboundProcedure}, so the {@link ProcedureCatalog} implementation cannot live in the shared base.
 */
