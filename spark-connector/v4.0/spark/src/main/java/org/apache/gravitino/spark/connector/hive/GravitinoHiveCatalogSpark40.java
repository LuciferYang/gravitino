...
/**
 * Spark 4.0 specific Gravitino Hive catalog implementation. Extends the shared base rather than the
 * Spark 3.5 class: the 3.x subclasses are compiled against the Spark 3 API and cannot be reused
 * here.
 */
