 ...
 *
 * <p>{@code ProcedureCatalog} is not declared here. Spark 4.0 moved the procedure API out of
...
public class GravitinoIcebergCatalog extends BaseCatalog
   ...
   * each version module's {@code loadProcedure} passes {@code GravitinoIcebergCatalog} to the
