...
public class HiveGravitinoOperationOperator {
  ...
  public void createPartition(
    ...
    try {
      ...
      // Spark 4.0 renamed the exception to PartitionsAlreadyExistException and removed its
      // single-String constructor, so use the (tableName, ident, schema) form available since 3.4.
