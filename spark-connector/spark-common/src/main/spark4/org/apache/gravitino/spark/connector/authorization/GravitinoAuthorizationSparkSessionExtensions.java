 ...
 *
 * <p>This is the Spark 4.x flavor. It is identical to the Spark 3.x flavor under {@code
 * src/main/spark3} except that Spark 4.0 added the abstract {@code parseRoutineParam} method to
 * {@link ParserInterface}. The two flavors keep the same fully-qualified name so the class-name
 * string registered in {@code GravitinoDriverPlugin} resolves to whichever flavor is on the
 * classpath, without any version dispatch.
 */
