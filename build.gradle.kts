...
subprojects {
  ...
  // Spark 4.0 requires JDK 17, so the 4.0 connector modules opt out of the JDK 8 target even though
  // the rest of :spark-connector (3.x) stays on Java 8.
  val jdk17OnlyProjectPaths = setOf(
    ":spark-connector:spark4-common",
